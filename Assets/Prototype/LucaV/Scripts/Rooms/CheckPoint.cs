...
public class CheckPoint : MonoBehaviour
{
    ...
    private void CreateRoom()
    {
        ...
        {
            Vector3 hallWayPos = transform.parent.position + (transform.position - transform.parent.position) + (transform.position - transform.parent.position).normalized * 5.5f; //DA CAMBIARE IN 5
